...
/**
    ...
    public static boolean isHttpOrHttps(String url){
        if(url != null && (url.startsWith("http") || url.startsWith("urls"))){
            return true;
        }
        return false;
    }
    ...
    public static boolean isNullString(String packageName) {
        return packageName == null || packageName.toLowerCase().equals("null");
    }
}
